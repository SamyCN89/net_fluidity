...
get_tenet4window_range(
    ...
    paths=paths,
    lag=data.lag,
    n_animals=all_animals_3d.shape[0],
    regions=regions,
    processors=processors,
    load_cache=load_cache_bool,
)
...
for i, c in enumerate(np.unique(communities)):
    ...
    get_tenet4window_range(
        ...
        paths=paths,
        lag=data.lag,
        n_animals=ts_500_3d_mod1.shape[0],
        regions=regions_mod1,
        processors=processors,
        load_cache=load_cache_bool,
    )
# %%
