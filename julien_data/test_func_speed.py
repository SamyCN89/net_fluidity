...
speed = dfc_speed(
    ws_5[0], vstep=50, method="pearson", return_fc2=False, tril_indices=None
)
# %%
...
plt.hist(
    (speed, speed2[3]), bins=50, alpha=0.5, histtype="step", label=("speed", "speed2")
)
